...
// TODOok: you'll need to import a library here
import UIKit
import AVFoundation
// TODOok: you'll need to edit this line to make your class conform to the AVCapturePhotoCaptureDelegate protocol
class ImagePickerViewController: UIViewController, AVCapturePhotoCaptureDelegate {
    ...
    // TODOok: add your instance methods for photo taking here
                ...
                if (device.hasMediaType(AVMediaTypeVideo)) {
                    if (device.position == AVCaptureDevicePosition.front) {
                        ...
                        if captureDevice != nil {
                            ...
                            do {
                                // TODOok: uncomment this line, and add a parameter to `addInput`
                            ...
                            if let previewLayer = AVCaptureVideoPreviewLayer(session: captureSession) { /* TODOok: replace this line by creating preview layer from session */
    ...
    override func viewDidLoad() {
        ...
        // TODOok: call captureNewSession here
